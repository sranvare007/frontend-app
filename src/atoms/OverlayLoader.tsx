...
function OverlayLoader({ height, width }: LoaderProps) {
  return (
    <div
      className={`w-screen h-screen absolute top-0 left-0 bottom-0 right-0 bg-slate-500 bg-opacity-80 text-white font-rajdhani font-medium flex justify-center items-center`}
    >
      <div
