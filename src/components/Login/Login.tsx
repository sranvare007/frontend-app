...
function Login({ setMethod }: LoginProps) {
  ...
  return (
    ...
    >
      <div className={`flex flex-col items-center w-1/3 shadow-md bg-white`}>
        <div className="flex flex-row items-center justify-center w-full bg-blue-400 py-3 rounded-tl-md rounded-tr-md">
          <p className={`font-rajdhani font-bold text-2xl text-white`}>Login</p>
        </div>
        ...
        <div className={`w-full px-6 pb-4`}>
          <button
            ...
            onClick={() => {
              setErrorMessage("");
              setMethod(globalConstants.method.SIGNUP);
            }}
          >
            Signup
          </button>
